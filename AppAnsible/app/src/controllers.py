    ...
    try:
        ...
        if not os.path.exists(key_path):
            try:
                ...
                print("Error al generar la llave SSH")
        ...
        try:
            ...
            print("Error al leer la llave pública")
        ...
        try:
            ...
            print("Error al escanear la huella digital del host remot")
            return {"error": "Error al escanear la huella digital del host remoto", "details": str(e)}
        except IOError as e:
            print("Error al escribir en el archivo known_hosts")
        ...
        try:
            ...
            print("Error al ejecutar comandos remotos")
